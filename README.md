...
4 年工业软件与制造数字化相关经验，覆盖产品设计、需求分析、产研协同与部分技术落地。深度参与国产三维管道设计软件核心功能建设，熟悉 **PDMS / E3D / PML / ISO 出图** 等场景，也持续实践 **Python / Rust / AI / 自动化工具** 在业务中的落地。
...
> ### 🏭 工业软件与规则抽象
>
> 🧭 围绕 **PDMS / E3D / PML / ISO 出图** 持续积累  
> 🧩 擅长把 **复杂业务规则** 拆成可执行方案  
> 🏗️ 关注 **三维设计 / CAD / 工程数字化** 场景  
> 🔍 会从底层逻辑、数据结构与规则约束反推产品设计  
> ⚙️ 比较在意方案是否真的能落地，而不只是“看起来合理”
...
>
> 📝 从业务目标出发梳理需求边界与优先级  
> 🧠 习惯把模糊想法整理成 PRD、流程、原型和规则说明  
> 🤝 重视研发沟通，希望把“差不多懂了”变成“真的对齐了”  
> 🔄 擅长在产品方案、实现成本与交付节奏之间做平衡  
> ✅ 比较看重闭环：不只提出想法，也希望它真正跑起来
...
> ### 🤖 工具化与 AI 落地
>
> 🛠️ 会把合适的需求继续做成工具、脚本或轻量实现  
> 🔎 持续尝试 **RAG / LLM / 自动化工作流** 在业务中的应用  
> 🐍 常用 **Python** 解决效率问题，也会用 **Rust / C#** 做更实的东西  
> 📦 对知识沉淀、流程提效、Demo 验证和快速落地比较有兴趣  
> 🚀 喜欢把“想到这了”继续推进成可用版本
